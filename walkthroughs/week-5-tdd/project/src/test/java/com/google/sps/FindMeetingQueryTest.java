...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredWithOptionalBusy() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(dayStart, duration),
  ...
  public void optionalOnlyWithGaps() {
    // Have 2 optional attendees with gaps in their schedules
    //
    // Events  : |--A--|     |--B--|
    // Day     : |---------------------|
    // Options :       |-----|     |---|
  ...
  public void optionalOnlyNoGaps() {
    // Have 2 optional attendees with no gaps in their schedules
    //
    // Events  : |--A-------|
    //                  |----B---------|
    // Day     : |---------------------|
